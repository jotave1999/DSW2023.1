<template>
  <section class="attachment-page" v-if="card">
    <div class="attachment-head">
      <span></span>
      <h3 class="card-item-title">Anexos</h3>
    </div>
    <div
    ...
    >
      ...
      <div class="attachment-title">
        ...
        <div class="links">
          <span>Adicionar {{ attach.createdAt | moment("from") }}</span>
          <a href="">Comentar</a>
          <a href="" @click.prevent="removeAttach(attach)">Deletar</a>
          <a href="" @click.prevent="toggleEdit(attach.id)">Editar</a>
          <edit-attachment
    ...
    <div class="attachment-btn">
      <button @click="toggleAddModal">Adicionar um Anexo</button>
    </div>
  </section>
</template>
